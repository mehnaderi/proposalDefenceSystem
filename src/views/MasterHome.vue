            ...
            <div class="col-12 p-0">
              <div dir="rtl">
                <div class="row font-weight-bold centerTODO text-info" dir="rtl">
                  ...
                  <!-- v-for="(student, i) in this.$store.getters.getStudentsList" :key="i" -->
                  <!-- {{this.$store.getters.getStudentsList}} -->
                  <router-link
                    to="/navReferee"
                    v-if="this.$store.getters.getStudentsList.length > 2"
                  >
                ...
                <div id="frst" class="card-body shadow pt-1 pb-1">
                  <div v-if="this.$store.getters.getStudentsList.length > 0">
                    <div v-for="(student, i) in this.$store.getters.getStudentsList" :key="i">
                      <div
                        v-if="i < 2"
                        class="border border-top-0 border-left-0 border-right-0 my-2"
                      >
                        <referee-item-layout :student="student" :index="i" />
                      </div>
                      <!-- <div v-if="this.$store.getters.getStudentsList.length > 1">
            ...
            <div class="col-12 p-0">
              <div dir="rtl">
                ...
                <div id="nxt" class="card-body shadow border">
                  ...
                  >برای انتخاب داوران پروپوزال ها و ویرایش زمان حضور کلیک کنید!</p>
                  <div class="row">
                    <div class="col-12 text-center">
                      <button
                        type="button"
                        class="btn colorSet ml-4"
                        data-toggle="modal"
                        data-target="#presentTimeModal"
                        dir="rtl"
                      >
      ...
      <div class="row p-0 modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="text-center">
            <button
              type="button"
              class="btn btn-default mb-3 mr-2 ml-2"
              data-dismiss="modal"
              dir="rtl"
            >
            ...
            <button
              type="button"
              class="btn btn-info mb-3 mr-2 ml-2"
              data-dismiss="modal"
              dir="rtl"
            >
...
export default {
  ...
  data() {
    return {
      refereeList: ["sd", "", ""], // این رو باید با لیست دانشجوها پر کنی getStudentsList
      parameters: 0,
      sliderArrayData: this.$store.getters.getNews,
      // sliderArrayData: [this.$store.getters.getToken, this.$store.state.name],
